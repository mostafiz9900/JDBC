...
public class SummaryService {
    ...
    public static void createTable() {
        String sql = "create table purchaseSalesSummary(id int auto_increment primary key, name varchar(50), pCode varchar(30), totalQuantity int(11), soldQuantity int(11), availableQuantity int(11), lastUpdate Date, pId int(11), foreign key (pId) references carPurchase(id))";
        try {
