...
public class PurchaseService {
    ...
    public static void createTable() {
        String sql = "create table carPurchase(id int auto_increment primary key, name varchar(30), pCode varchar(30), quantity int(11), unitPrice double, totalPrice double, purchaseDate Date)";
        try {
    ...
    public static void insertToPurchase(carPurchase purchase) {
        if (purchase != null) {
            insert(purchase);
            carPurchase p = getPurchaseByProductCode(purchase.getpCode());
