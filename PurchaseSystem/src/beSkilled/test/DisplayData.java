...
import beSkilled.domain.ViewList;
...
public class DisplayData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblDisplayDataP = new javax.swing.JTable();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Product Data"));

        jLabel3.setText("Id");

        jLabel4.setText("Name");

        jLabel5.setText("P_Date");

        jLabel6.setText("ToalPrice");

        jLabel7.setText("Qty");

        jLabel8.setText("Q_price");
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(txtQty)
                                .addComponent(txtCatId, javax.swing.GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE)
                                .addComponent(txtPurchaseDate)
                                .addComponent(txtTotalPrice)
                                .addComponent(txtQPrice))
                            .addComponent(btnInsert2, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
                    .addComponent(txtQPrice, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("P_ Data display"));

        tblDisplayDataP.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Id", "Name", "Qty", "QPrice", "TotalPrice", "P_date", "cat_id"
            }
        ));
        jScrollPane2.setViewportView(tblDisplayDataP);
    ...
    public void displayDataList() {
        List<Category> list = ViewList.getCategoryList();
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        CategoryService.insertDatsC(c);
        displayDataList();
    }//GEN-LAST:event_btnInsertActionPerformed
    public void productDataDisplay() {
        List<Product> p = ViewList.getProductList();
        DefaultTableModel model = (DefaultTableModel) tblDisplayDataP.getModel();
        Object[] row = new Object[7];
        model.setRowCount(0);
        for (int i = 0; i < p.size(); i++) {
            row[0] = p.get(i).getId();
            row[1] = p.get(i).getName();
            row[2] = p.get(i).getQty();
            row[3] = p.get(i).getUnitPrice();
            row[4] = p.get(i).getTotalPrice();
            row[5] = p.get(i).getPurchseDate();
            row[6] = p.get(i).getCategory().getId();
            model.addRow(row);
    ...
    private void btnInsert2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsert2ActionPerformed
        ...
        p.setName(txtNameP.getText());
        p.setQty(Integer.parseInt(txtQty.getText()));
        p.setUnitPrice(Double.parseDouble(txtQPrice.getText()));
    ...
    private javax.swing.JTable tblDisplayDataP;
