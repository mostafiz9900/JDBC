...
static Connection con=null;
    ...
    try {
        ...
        ps.executeUpdate();
        System.out.println("data insert purchase");
    } catch (SQLException ex) {
        Logger.getLogger(PurchaseService.class.getName()).log(Level.SEVERE, null, ex);
    }
    }

    public static Purchase getPurchaseByPruductCode(String code) {
    ...
    public static List<Purchase> getPurchseList() {
    ...
    public static void insertMain(Purchase purchase) {
        if (purchase != null) {
            insert(purchase);
            Purchase p = getPurchaseByPruductCode(purchase.getCode());
            try {
